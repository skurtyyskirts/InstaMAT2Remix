...
def _ensure_qt_loaded() -> bool:
    ...
    try:
        ...
        print('[InstaMAT2Remix Python] Could not import PySide6.QtCore.')
        QT_AVAILABLE = False
        return False
...
class RemixConnector:
    ...
    def on_pull_from_remix(self):
        # Zero-prompt Pull (Substance2Remix parity): tiling-mesh behavior comes
        # from Settings, never from a click-time dialog.
